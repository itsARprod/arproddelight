...
public class Modelaxolotlarmor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "axolotlarmor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(32, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(3, 5)
						.addBox(-4.0F, -11.0F, 1.0F, 8.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 8)
						.addBox(-7.0F, -10.0F, 1.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(11, 8)
						.addBox(4.0F, -10.0F, 1.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
