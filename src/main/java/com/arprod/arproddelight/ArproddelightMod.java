...
public class ArproddelightMod {
	public static final Logger LOGGER = LogManager.getLogger(ArproddelightMod.class);
	public static final String MODID = "arproddelight";

	public ArproddelightMod() {
        ...
        ArproddelightModRecipes.register(FMLJavaModLoadingContext.get().getModEventBus());

        ArproddelightModBlockEntities.register(FMLJavaModLoadingContext.get().getModEventBus());
