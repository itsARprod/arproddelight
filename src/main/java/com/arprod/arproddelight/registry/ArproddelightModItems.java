...
public class ArproddelightModItems {
    ...
    public static final RegistryObject<Item> MARGHERITA_PIZZA_SLICE= REGISTRY.register("margherita_pizza_slice", MargheritaPizzaSliceItem::new);
    public static final RegistryObject<Item> SALAMI_PIZZA_SLICE= REGISTRY.register("salami_pizza_slice", SalamiPizzaSliceItem::new);
    public static final RegistryObject<Item> BOSCAIOLA_PIZZA_SLICE= REGISTRY.register("boscaiola_pizza_slice", BoscaiolaPizzaSliceItem::new);
...
//    public static final RegistryObject<Item> STRAWBERRY_CHEESECAKE_SLICE= REGISTRY.register("strawberry_cheesecake_slice", StrawberryCheesecakeSliceItem::new);
    ...
    public static final RegistryObject<Item> CINNAMON_LOG = block(ArproddelightModBlocks.CINNAMON_LOG);
    public static final RegistryObject<Item> CINNAMON_WOOD = block(ArproddelightModBlocks.CINNAMON_WOOD);
