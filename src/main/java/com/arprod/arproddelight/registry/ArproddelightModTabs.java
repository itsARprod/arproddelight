...
public class ArproddelightModTabs {
    ...
    public static final RegistryObject<CreativeModeTab> ARPRODDELIGHT = REGISTRY.register("arproddelight",
            () -> CreativeModeTab.builder().title(Component.translatable("item_group.arproddelight.a_rprods_delight")).icon(() -> new ItemStack(CHEESE.get())).displayItems((parameters, tabData) -> {
                        java.util.List.of(
                                        //blocks
                                        TONIR.get(),
                                        FRYING_BASKET.get(),
